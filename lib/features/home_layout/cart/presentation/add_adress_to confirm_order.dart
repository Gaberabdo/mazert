...
class AddAdressToConfirmOrder extends StatefulWidget {
  ...
  @override
  State<AddAdressToConfirmOrder> createState() => _AddAdressToConfirmOrderState();
}
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text(
                        AppLocalizations.of(context)!.thenameofthissiteforexampleis,
                    ),
                  ],
                ),
              ),
                Form(
                    ...
                    child: Column(
                  children: [
                    CustomTextFormFiled(label: " ", controller: controller,
                      validator: (text) {
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text(AppLocalizations.of(context)!.locationindetail),
                        ],
                      ),
                    ),
                    CustomTextFormFiled(label: " ", controller: controller,
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text(
                              AppLocalizations.of(context)!.thephonenumberatthelocation),
                        ],
                      ),
                    ),
                    CustomPhoneTextField(text: " ", controller: controller,
                      validator: (text) {
                        if (text!.isEmpty || text == null) {
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text(AppLocalizations.of(context)!.pleaseselectthebranch,),
                  ],
                ),
              ),
              Padding(
                ...
                child: Directionality(
                  ...
                  child: DropdownButton(
                    ...
                    elevation: 1.sign,
                    isExpanded: true,
                    hint: Text(AppLocalizations.of(context)!.choosebranch,),
              ...
              Padding(
                padding:  EdgeInsets.only(left: 10.w,right: 10.w,top: 30.h,bottom: 20.h),
                child: CustomTextFormFieldConnectUs(
                    label: AppLocalizations.of(context)!.deliverynotestothisaddress,
